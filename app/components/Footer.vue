    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
      ...
      <div>
        ...
        <div class="flex gap-2.5">
          <a href="https://x.com/jazeelnet" class="w-9 h-9 rounded-lg bg-white/[0.05] flex items-center justify-center text-white/35 hover:bg-jgreen/15 hover:text-jgreen transition-all">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a href="https://www.linkedin.com/company/jazeelnet" class="w-9 h-9 rounded-lg bg-white/[0.05] flex items-center justify-center text-white/35 hover:bg-jgreen/15 hover:text-jgreen transition-all">
        ...
        <div class="mt-6">
          ...
          <div class="flex gap-2">
            <input type="email" placeholder="بريدك الإلكتروني" class="flex-1 px-4 py-2.5 rounded-sys bg-white/[0.05] border border-white/[0.08] text-body-sm text-white placeholder:text-white/25 focus:outline-none focus:border-jgreen/40 transition-colors">
            <button class="btn-primary" style="padding:0.625rem 1rem;font-size:0.8125rem;">اشترك</button>
          </div>
        </div>
      </div>
    </div>
